...
class RecipeAdapter (private val recipes: List<Recipe>) : RecyclerView.Adapter<RecipeAdapter.ViewHolder>(){
        ...
        class ViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
            ...
            init {
                ...
                ingredientsTextView = itemView.findViewById(R.id.senderTv)
                titleTextView = itemView.findViewById(R.id.titleTv)
                photoTextView = itemView.findViewById(R.id.summaryTv)
            }
        }
        ...
        override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
            ...
            val contactView = inflater.inflate(R.layout.recipe_list_item, parent, false)
